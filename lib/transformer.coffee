...
module.exports =
  ...
  activate: ->
    ...
    @subscriptions.add atom.commands.add 'atom-workspace',
      ...
      'transformer:wordInvert': => @wordInvert()
      'transformer:wordReverse': => @wordReverse()
      'transformer:calculate': => @calculate()
      'transformer:wordWave': => @wordWave()
      'transformer:camelCase': => @camelCase()
      'transformer:underscoreCase': => @underscoreCase()
      'transformer:wordShuffle': => @wordShuffle()
